...
@Component({
  ...
  <mat-card-actions>
  <div><span class="vote">{{upVote}}</span> <a (click)="upVoteClicked.emit()">
   <i style="cursor: pointer;" class="material-icons">thumb_up</i></a>
  </div> <div><span class="vote">{{downVote}}</span><a (click)="downVoteClicked.emit()">
  <i style="cursor: pointer;" class="material-icons">thumb_down</i></a>
